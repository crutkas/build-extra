...
test -20 = "$((current_combined_x64 - current_busybox_x64))" &&
test 20 = "$((current_combined_arm64 - current_busybox_arm64))" ||
die "The current file-list OpenSSH architecture delta is not -20 x64/+20 ARM64"
